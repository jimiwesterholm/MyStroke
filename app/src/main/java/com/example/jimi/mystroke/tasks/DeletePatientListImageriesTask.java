...
public class DeletePatientListImageriesTask extends AsyncTask<PatientListImagery, Void, Boolean> {
    private AsyncResponse asyncResponse;
    private AppDatabase appDatabase;
    public static final int var = 12;

    public DeletePatientListImageriesTask(AsyncResponse asyncResponse, AppDatabase appDatabase) {
